...
class Discriminator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(ndf * 32, 1, 1, 2, 0, bias=False),
...
if __name__ == "__main__":
    ...
    # x = real_batch * 255
    # img_grid = vutils.make_grid(x.to(device)[:16], padding=2, normalize=True).cpu()
    # img_grid = np.transpose(img_grid, (1, 2, 0))
    # plt.imshow(img_grid)
    # plt.savefig('training_images.png', bbox_inches='tight', pad_inches=0)
    # plt.close()
